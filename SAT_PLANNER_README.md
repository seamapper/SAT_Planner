...
```
SAT_Planner/
├── SAT_Planner_PyQt.py    # Main application (PyQt6)
├── Sat_Planner_v2025.05.spec  # PyInstaller spec file
├── build_exe.bat          # Build script for executable
├── README.md              # Main README for GitHub
├── SAT_PLANNER_README.md  # This file
└── media/
    └── CCOM.ico           # Application icon
```
...
### Architecture
- **GUI**: PyQt6-based interface with matplotlib integration
